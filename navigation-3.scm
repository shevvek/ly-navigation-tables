...
(define (sort-by-location nav-table)
...
(define (finalize-nav-data! nav-table)
  "Process data collected in a @code{Score}'s @code{navigationTable}"
...
(define (record-origins-where-timing! ctx)
